...
public class BumenjingliController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		BumenjingliEntity user = bumenjingliService.selectOne(new EntityWrapper<BumenjingliEntity>()
				.eq("jingligonghao", username));
    ...
    public R register(@RequestBody BumenjingliEntity bumenjingli){
    	...
    	BumenjingliEntity user = bumenjingliService.selectOne(new EntityWrapper<BumenjingliEntity>()
				.eq("jingligonghao", bumenjingli.getJingligonghao()));
		if(user!=null) {
